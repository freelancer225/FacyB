                        ...
                        <div class="card" style="background-color:#efefef; padding:2%; border:1px solid #ccc; margin-top:2%">
                          <div class="card-body">
                            ...
                            <div class="card-text" style="color:#333">
                              ...
                              <div class="row">
                                <div class="col-md-offset-1 col-md-3">
                                  <span style="font-size:15px !important; font-weight:bold">{{$formation->name_ecole}} </span>
                                </div>                                
                              </div>  <br>                          
                              @endforeach
                            ...
                            <p class="card-text">
                              ...
                              <tr>
                                <td><span style="font-size:15px !important; font-weight:bold">Niveaux : </span> </td>
                                <td>{{$experience->poste}} </td>
                              </tr><br>
                              <tr>
                                <td><span style="font-size:15px !important; font-weight:bold">experience : </span> </td>
